                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Show Role</h6>
                    <div class="pull-right">
                        <a class="btn btn-primary" href="{{ url('/showpermissions') }}"> Back</a>
                    </div>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-body" contenteditable="false">
                       <form role="form" {{ action('PermissionsController@editpermissions',['id' => $id->id]) }}  method="POST" class="">
                        {{ csrf_field() }}
                               ...
                               <table class="">
                                   <tbody>
                                       <tr>
                                           ...
                                           <td>
                                               <input type="text" class="form-control" id="exampleInputEmail1" value="{{ $id->name }}" name="name" placeholder="Enter Permission Name" style="display:inline;width:500px;">
                                           </td>
                                       </tr>
                                   </tbody>
                               </table>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <select class="mdb-select md-form" name="guard_name">
                                                ...
                                                <option value="web"{{ $id->guard_name == 'web'? 'selected' : ''}}>web</option>
                                              </select>
                                           </td>
                                       </tr>
                                   </tbody>
